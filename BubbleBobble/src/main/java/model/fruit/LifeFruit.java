...
/**
 * The type of fruit which adds one life of the hero.
 */
public class LifeFruit extends Fruit{
     ...
     */
    public LifeFruit(int x, int y, GameController gameController, ImageView fruitImageView, PowerUpBehavior powerUpBehavior, int pointValue) {
